...
| Method                                    | Type    | Default value | Description                                                                                                                                                                                        |
| ----------------------------------------- | ------- | ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| _map_.**compositionSettings**([*value*])  | object  | _auto_        | Composition-level settings for chart symbols: `type`, `minSize`, `maxSize`, `strokeFill`, `strokeWidth`, `stripesOrientation`, `offsetAngle`, `agePyramidHeightFactor`, `otherColor`, `otherText`. |
