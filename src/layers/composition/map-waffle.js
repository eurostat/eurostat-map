...
/** @typedef {import('../../types/layers/composition/waffle/WaffleMapConfig').WaffleMapConfig} WaffleMapConfig */
/** @typedef {import('../../types/layers/composition/waffle/WaffleMap').WaffleMap} WaffleMap */
...
export const decorateWaffleLayer = function (out, config) {
    ...
    function applyStyleToMap(map) {
        ...
        // Reuse the main map tooltip so hover still works. out is the waffle layer, so its
