...
/** @typedef {import('../../types/layers/composition/coxcomb/CoxcombMapConfig').CoxcombMapConfig} CoxcombMapConfig */
/** @typedef {import('../../types/layers/composition/coxcomb/CoxcombMap').CoxcombMap} CoxcombMap */
