...
/** @typedef {import('../types/layers/CateogricalMapConfig').CategoricalMapConfig} CategoricalMapConfig */
/** @typedef {import('../types/layers/CategoricalMap').CategoricalMap} CategoricalMap */
