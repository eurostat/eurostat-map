;(function (root, factory) {
    ...
    const paths = [
        ...
        'choropleth/custom-geometries.html',
        ...
        'flow/flowmap.html',
        'miscellaneous/annotations.html',
        'miscellaneous/export.html',
        'miscellaneous/hatching.html',
        'miscellaneous/locations.html',
        'miscellaneous/minimap.html',
        'miscellaneous/placenames.html',
        'miscellaneous/projection.html',
        'miscellaneous/scalebar.html',
        'miscellaneous/stamp.html',
        'miscellaneous/story-map/index.html',
        'mushroom/mushroom.html',
        'pie-charts/prop-piecharts.html',
        'proportional/population-total.html',
        'proportional/prop-circles.html',
        'proportional/prop-symbols.html',
